...
namespace AnimalFarmsMarket.Core.Controllers.Api
{
    ...
    public class TrackingController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddTracking([FromBody] AddTrackingDto addTracking)
        {
            ...
            var deliveryPerson = await _userManager.Users.Include(x => x.DeliveryPerson).FirstOrDefaultAsync(x => x.DeliveryPerson.Id == addTracking.DeliveryPersonId);
        ...
        public async Task<IActionResult> GetTrackingByTrackingNumber([FromQuery] int number)
        {
