...
namespace AnimalFarmsMarket.Core.Controllers.Api
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddDeliveryPerson([FromBody] RegisterDeliveryPersonDto model)
        {
            ...
            var ss = NotificationsHelper.EmailHtmlStringTemplate($"{user.FirstName} {user.LastName}", "", queryParams, "emailConfirmTemplate.html", HttpContext);
        ...
        public async Task<IActionResult> RegisterAgent([FromBody]RegisterAgentDto model)
        {
            ...
            var template = NotificationsHelper.EmailHtmlStringTemplate($"{user.FirstName} {user.LastName}", "email-confirm", queryParams, "emailConfirmTemplate.html", HttpContext);
